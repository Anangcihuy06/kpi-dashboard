...
for page in range(3):
    url2 = f"https://talent-backend.andreasbilly.com/api/app/users/attendances-new?page={page}&size=200&sort=clockin_timesheet&startDate=2026-01-01&endDate=2026-12-31"
